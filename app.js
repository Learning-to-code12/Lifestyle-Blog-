...
app.get("/blog", function(req, res) {
  Article.find(function(err, foundArticles){
    if(!err){
      if (userEmail == 0) {
        res.render("blog", {publicHome: homeContentPublic, postingPublicPosts: foundArticles, addMessage: req.flash('addMessage'), login: 0});
      } else {
        res.render("blog", {publicHome: homeContentPublic, postingPublicPosts: foundArticles, addMessage: req.flash('addMessage'), login: 1});
      }
